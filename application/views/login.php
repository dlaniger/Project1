  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	...
	  	<div align="center">
	  		<img src="<?php echo assets_url('img/tiki_trotter_big.png'); ?>" ng-click="testMe()">
	  	</div>
		            ...
		            <hr/>
		                <a class="" href="#createAccount" data-toggle="modal">
		                    ...
		                    <!-- <span align="center"> -->
		                    	<!-- OR -->
		                    <!-- </span><br/> -->
		                    <!-- <button class="btn btn-facebook" type="submit"><i class="fa fa-facebook"></i> Login with Facebook</button> -->
		                </a>
		            </div>
		      ...
		      <div align="center" style="margin-top: 70px;">
		      	<font face="verdana" color="#fff" size="1px;">
